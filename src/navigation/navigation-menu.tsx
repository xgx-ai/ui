 ...
 * # Navigation Menu
 *
 * Complex navigation with dropdown content.
 *
 * @example
 * ```
 * <NavigationMenu>
 ...
 *       <NavigationMenuIcon />
 *     </NavigationMenuTrigger>
 *     <NavigationMenuContent class="grid w-[400px] gap-3 p-4">
