...
const DatePicker = (props: DatePickerPrimitive.RootProps) => {
...
interface DatePickerContentProps extends DatePickerPrimitive.ContentProps {
  ...
  return (
    <DatePickerPrimitive.TableCellTrigger
      class={cn(
        ...
        "data-today:border-1 data-today:border-primary data-today:text-primary",
        "[&:is([data-today][data-selected])]:bg-primary/10 [&:is([data-today][data-selected])]:text-primary-foreground",
        "data-selected:bg-primary/10 data-selected:border-primary data-selected:text-primary data-selected:hover:bg-primary/80 data-selected:hover:text-primary-foreground",
