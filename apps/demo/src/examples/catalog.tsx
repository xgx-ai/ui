...
export const primarySections = [
  ...
  { id: "map", label: "MapLibre", icon: MapPinned },
...
export const sectionDescriptions: Record<SectionId, string> = {
  ...
  map: "Solid 2 map composition with offline styles, sources, layers, and controls.",
...
export const coverageRows = [
  ...
  ["MapLibre", "Offline style, GeoJSON sources, layers, controls, marker, popup", "Live"],
