...
export const StepCard: Component<StepCardProps> = (props) => {
  ...
  return (
    <div
      class={cn(
        "group flex items-start gap-3 p-3 rounded-md",
        "bg-surface border border-border-subtle",
        "transition-all duration-200",
        local.editable && "hover:bg-hover hover:text-hover-foreground cursor-pointer",
        local.class,
      )}
    ...
    >
      ...
      <div class="flex-1 min-w-0">
        ...
        <p class="text-sm font-medium text-foreground truncate">{local.value}</p>
